...
const DropZone = {
    ...
    onFileRead : function(sText)
    {
        ...
        try
        {
            ...
            document.body.dispatchEvent(new CustomEvent("meccg-deckbuilder-load-deck", { "detail": json }));
        }
        catch (e)
        {
...
document.body.addEventListener("meccg-init-ready", DropZone.init, false);
