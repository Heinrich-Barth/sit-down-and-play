...
module.exports = 
{
     ...
     * @returns 
     */
    setup : function(_agentList) 
    {
        return new PlayBoardManagement(require("./deck-manager.js").setupDecks(), _agentList);
    }
};

let PlayBoardManagement = function(_Decks, _listAgents)
{
