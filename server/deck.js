...
function add(cards, _targetList, playerId, _cardMap, listAgents, nSizeSoFar)
{
    let nSize = nSizeSoFar;
    var card, _entry;
...
function _create(playerId, jsonDeck, listAgents, type, _cardMap)
{
    ...
    let nSize = 0;
    nSize = add(jsonDeck["pool"], deck.handCards, playerId, _cardMap, listAgents, 0);
    nSize = add(jsonDeck["resources"], deck.playdeck, playerId, _cardMap, listAgents, nSize);
    nSize = add(jsonDeck["hazards"], deck.playdeck, playerId, _cardMap, listAgents, nSize);
    nSize = add(jsonDeck["chars"], deck.playdeck, playerId, _cardMap, listAgents, nSize);
    nSize = add(jsonDeck["avatar"], deck.playdeck, playerId, _cardMap, listAgents, nSize);
    nSize = add(jsonDeck["sideboard"], deck.sideboard, playerId, _cardMap, listAgents, nSize);
