...
module.exports = {
    ...
    game: function (_MeccgApi, _Chat, _agentList)
    {
        /**
         * todo: use quest list
         */
        return new GameInstance(_MeccgApi, 
                                _Chat, 
                                require("./playboard-management.js").setup(_agentList), 
                                require("./scores.js").create());
    }
};

var GameInstance = function(_MeccgApi, _Chat, _playboardManager, _score)
{
    const Game =
    {
